...
public class SpecsRestIntegrationTest extends AbstractIntegrationTest {

    @Test
    public void shouldListSearch() throws Exception {
        mockMvc.perform(get("/specs")) //
        .andExpect(status().isOk()) //
        .andExpect(links().withRelIsPresent(SpecsLinks.REL_SEARCH));
    }
}
