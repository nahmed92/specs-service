...
public class RootLinksTest extends AbstractIntegrationTest {

    @Test
    public void shouldRenderRootLinkForSpecs() throws Exception {
        mockMvc.perform(get("/")) //
        .andExpect(status().isOk()) //
        .andExpect(links().withRelIsPresent("specs"));
    }
}
